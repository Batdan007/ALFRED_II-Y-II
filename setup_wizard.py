...
class SetupWizard:
    """GUI Setup Wizard for ALFRED_UBX."""
    
    def __init__(self):
        self.root = tk.Tk()
        self.root.title("ALFRED_UBX Setup Wizard")
...
"""
        ...
        try:
            ...
            if not req_file.exists():
                messagebox.showerror(
                    "Error",
                    "requirements.txt not found!\n\nPlease ensure you're running this from the ALFRED_UBX directory."
                )
                return
    ...
    def _show_help(self):
        ...
        help_text = """ALFRED_UBX Setup Wizard Help
...
def run_cli_setup():
    ...
    print("\n" + "=" * 60)
    print("  ALFRED_UBX Setup (Command Line)")
    print("=" * 60)
